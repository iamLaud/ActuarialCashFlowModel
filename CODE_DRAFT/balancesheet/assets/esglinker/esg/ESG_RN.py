## Python packages
import numpy as np
from esg.credit_risk import JLT
from esg.interest_rate import Hull_White_one_factor
from esg.model_equity import GBM_constant_volatility
...
class ESG_RN(object):
    ...
    def __init__(self) :
        ...
        self.IR_model = Interest_rate
        self.EQ_model = Equity
        self.credit_model = credit
